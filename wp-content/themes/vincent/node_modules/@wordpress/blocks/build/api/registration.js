...
function unstable__bootstrapServerSideBlockDefinitions(definitions) {
  for (const blockName of Object.keys(definitions)) {
    ...
    serverSideBlockDefinitions[blockName] = Object.fromEntries(Object.entries((0, _lodash.pickBy)(definitions[blockName], value => value !== null && value !== undefined)).map(_ref => {
      let [key, value] = _ref;
...
function translateBlockSettingUsingI18nSchema(i18nSchema, settingValue, textdomain) {
  ...
  if (isObject(i18nSchema) && !(0, _lodash.isEmpty)(i18nSchema) && isObject(settingValue)) {
