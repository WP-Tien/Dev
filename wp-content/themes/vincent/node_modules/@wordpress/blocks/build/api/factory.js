...
function getBlockTransforms(direction, blockTypeOrName) {
  ...
  if (blockTypeOrName === undefined) {
    return (0, _registration.getBlockTypes)().map(_ref => {
      let {
        name
      } = _ref;
...
function switchToBlockType(blocks, name) {
  ...
  const hasSwitchedBlock = (0, _lodash.some)(transformationResults, result => result.name === name); // Ensure that at least one block object returned by the transformation has
