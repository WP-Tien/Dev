...
const processBlockType = (blockType, _ref) => {
  ...
  if (settings.deprecated) {
    settings.deprecated = settings.deprecated.map(deprecation => pick( // Only keep valid deprecation keys.
  ...
  if ('category' in settings && !some(select.getCategories(), {
...
export const __experimentalRegisterBlockType = blockType => _ref2 => {
  let {
    dispatch,
    select
  } = _ref2;
...
export const __experimentalReapplyBlockTypeFilters = () => _ref3 => {
  let {
    dispatch,
    select
  } = _ref3;
