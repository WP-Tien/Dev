...
export function blockStyles() {
  ...
  switch (action.type) {
    ...
    case 'REMOVE_BLOCK_STYLES':
      return { ...state,
        [action.blockName]: filter(get(state, [action.blockName], []), style => action.styleNames.indexOf(style.name) === -1)
      };
  }
...
export function blockVariations() {
  ...
  switch (action.type) {
    ...
    case 'REMOVE_BLOCK_VARIATIONS':
      return { ...state,
        [action.blockName]: filter(get(state, [action.blockName], []), variation => action.variationNames.indexOf(variation.name) === -1)
      };
  }
