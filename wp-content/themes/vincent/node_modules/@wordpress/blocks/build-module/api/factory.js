...
import { every, castArray, some, filter, first, has, isEmpty, map } from 'lodash';
/**
...
export function switchToBlockType(blocks, name) {
  ...
  const hasSwitchedBlock = some(transformationResults, result => result.name === name); // Ensure that at least one block object returned by the transformation has
