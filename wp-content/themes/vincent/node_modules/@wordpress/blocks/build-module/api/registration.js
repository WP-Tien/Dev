...
export function unstable__bootstrapServerSideBlockDefinitions(definitions) {
  for (const blockName of Object.keys(definitions)) {
    ...
    serverSideBlockDefinitions[blockName] = Object.fromEntries(Object.entries(pickBy(definitions[blockName], value => value !== null && value !== undefined)).map(_ref => {
      let [key, value] = _ref;
...
function translateBlockSettingUsingI18nSchema(i18nSchema, settingValue, textdomain) {
  ...
  if (Array.isArray(i18nSchema) && !isEmpty(i18nSchema) && Array.isArray(settingValue)) {
    return settingValue.map(value => translateBlockSettingUsingI18nSchema(i18nSchema[0], value, textdomain));
  }

  if (isObject(i18nSchema) && !isEmpty(i18nSchema) && isObject(settingValue)) {
...
export function registerBlockCollection(namespace, _ref3) {
  let {
    title,
    icon
  } = _ref3;
